...
public class Enemy3StateMachine : WaveEnemyStateMachine
{   
    [Header("States")]
    ...
    [Range(0f, 50f)] public float runColliderRadius;
    ...
    void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawWireSphere(transform.position, runColliderRadius);
    }
