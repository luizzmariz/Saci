...
public class Boss1DamageState : BaseState
{
    ...
    public IEnumerator Knockback()
    {
        ...
        enemyStateMachine.rigidBody.AddForce(enemyStateMachine.knockbackVector * enemyStateMachine.knockbackPower, ForceMode.Impulse);
