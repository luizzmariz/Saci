...
public class CharacterOrientation : MonoBehaviour
{
    ...
    public Transform handSpriteTransform;
    public Vector3 lastOrientation;
    ...
    {
        //Debug.Log("CharacterOrientation - targetPoint: " + targetPoint);
        ...
        if(relativePos != Vector3.zero)
        {
            ...
            handSpriteTransform.rotation = Quaternion.Euler(handSpriteTransform.rotation.eulerAngles.x, handSpriteTransform.rotation.eulerAngles.y,  (int)-(LookAtRotation.eulerAngles.y+180));
            handTransform.rotation = Quaternion.Euler(handTransform.rotation.eulerAngles.x, (int)(LookAtRotation.eulerAngles.y+180), handTransform.rotation.eulerAngles.z);


            lastOrientation = relativePos;
            // CheckSpriteOrientation(relativePos); --- Old way of changing sprites
            spriteHandler.ChangeSprite((int)handSpriteTransform.rotation.eulerAngles.z);
        }
        else
        {
